...
function updateGroupGeometry123( mesh, geometry123 ) {
...
var guis = {
	...
	TestGeometry : function( mesh ) {
		...
		var folder = gui.addFolder( 'Manage Box size' );

		folder.add( data, 'width', 1, 30 ).onChange( updateGeometry );
		folder.add( data, 'height', 1, 30 ).onChange( updateGeometry );
		folder.add( data, 'depth', 1, 30 ).onChange( updateGeometry );
		folder.add( data, 'widthSegments', 1, 10 ).step( 1 ).onChange( updateGeometry );
		folder.add( data, 'heightSegments', 1, 10 ).step( 1 ).onChange( updateGeometry );
		folder.add( data, 'depthSegments', 1, 10 ).step( 1 ).onChange( updateGeometry );
